...
# # DKVMN_trainer 클래스의 인스턴스 생성
# trainer = DKVMN_trainer()

# # _train 함수 호출하여 반환된 값을 변수에 저장
# result = trainer._train(train_loader, metric_name)

# # 저장된 결과를 출력
# print("q_seqs:", result['q_seqs'])
# print("r_seqs:", result['r_seqs'])
# print("qshft_seqs:", result['qshft_seqs'])
# print("rshft_seqs:", result['rshft_seqs'])
# print("mask_seqs:", result['mask_seqs'])
